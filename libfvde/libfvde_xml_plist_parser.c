...
#define yyparse         xml_plist_scanner_parse
#define yylex           xml_plist_scanner_lex
#define yyerror         xml_plist_scanner_error
#define yydebug         xml_plist_scanner_debug
#define yynerrs         xml_plist_scanner_nerrs

#define yylval          xml_plist_scanner_lval
#define yychar          xml_plist_scanner_char
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_XML_PLIST_SCANNER_LIBFVDE_XML_PLIST_PARSER_H_INCLUDED
# define YY_XML_PLIST_SCANNER_LIBFVDE_XML_PLIST_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
#if YYDEBUG
extern int xml_plist_scanner_debug;
#endif
...
extern YYSTYPE xml_plist_scanner_lval;

int xml_plist_scanner_parse (void *parser_state);

#endif /* !YY_XML_PLIST_SCANNER_LIBFVDE_XML_PLIST_PARSER_H_INCLUDED  */
...
{
       0,   177,   177,   180,   182,   185,   187,   190,   192,   196,
     197,   198,   202,   261,   265,   287,   335,   369,   371,   375
};
#endif
...
yyreduce:
  ...
  case 15:

    {
		...
		if( ( ( (xml_plist_parser_state_t *) parser_state )->current_tag->name_size != ( (yyvsp[0].string_value).length + 1 ) )
